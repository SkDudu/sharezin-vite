  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-blue-900 text-stone-50 focus:bg-blue-900 focus:text-stone-50 dark:bg-stone-50 dark:text-stone-900 dark:hover:bg-stone-50 dark:hover:text-stone-900 dark:focus:bg-stone-50 dark:focus:text-stone-900",
        day_today: "bg-blue-100 text-blue-400 dark:bg-stone-800 dark:text-stone-50",
        day_outside:
